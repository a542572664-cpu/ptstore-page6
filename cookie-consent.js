(function () {
  ...
  function renderConsentDialog() {
    ...
    container.innerHTML = [
      ...
      '      <p>Meta Pixel loads only with your permission. Rejecting marketing cookies will not affect essential site features. <a href="cookies.html">Cookie Policy</a>.</p>',
      '    </div>',
      ...
      '    <p>Choose which optional technologies you want to allow. Necessary functions remain active so your preference can be saved.</p>',
      ...
      '      </label>',
      '    </div>',
      '    <p class="cookie-consent-note">You can update your choice at any time through “Cookie Settings” in the footer.</p>',
      '    <div class="cookie-consent-actions">',
